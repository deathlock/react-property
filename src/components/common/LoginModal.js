            ...
            <div className="left-wrap">
              <div className="left-inner">
                <div className="form-group">
                  <input type="text" name="smartPhoneLogin" value={this.state.smartPhoneLogin} className="form-control" />
                </div>
              ...
              <div className="right-inner">
                <div className="search-area">
                  ...
                  <form action="#" method="post" className="form-area">
                    <input type="text" name="name" placeholder="Search Location" className="form-control" />
